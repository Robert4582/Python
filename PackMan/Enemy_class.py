...
class Enemy:
    ...
    def update(self):
        ...
        self.grid_pos[0] = (self.pix_pos[0]-Top_button_Buffer +
                            self.app.cell_width//2)//self.app.cell_width+1
        self.grid_pos[1] = (self.pix_pos[1]-Top_button_Buffer +
                            self.app.cell_Height//2)//self.app.cell_Height+1

    def draw(self):
        pygame.draw.circle(self.app.screem, self.colour,
    ...
    def get_pix_pos(self):
        return vec((self.grid_pos.x*self.app.cell_width)+Top_button_Buffer//2+self.app.cell_width//2,
                   (self.grid_pos.y*self.app.cell_Height)+Top_button_Buffer//2 +
